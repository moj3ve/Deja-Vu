#import "DVUContributorsSubPreferencesListController.h"

@implementation DVUContributorsSubPreferencesListController
...
- (void)loadFromSpecifier:(PSSpecifier *)specifier {
    ...
    NSString* sub = [specifier propertyForKey:@"DVUSub"];
